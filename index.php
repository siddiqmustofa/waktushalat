...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <h1>
                Wujudkan Masjid yang<br>
                <span class="highlight">Transparan & Terhubung</span>
            </h1>
            <p>
                Sistem informasi digital masjid yang lengkap dengan jam digital, jadwal shalat, info kajian, transparansi keuangan, dan info khutbah Jumat dalam satu platform
            </p>
            <div class="hero-buttons">
                <a href="#daftar" class="btn btn-primary btn-lg">Mulai Gratis</a>
                <a href="#demo" class="btn btn-outline btn-lg">Lihat Demo</a>
            </div>
        </div>
    ...
    <section id="daftar" class="cta">
        <div class="cta-content">
            ...
            <a href="#" class="btn btn-white btn-lg">Daftar Sekarang - Gratis</a>
        </div>
    </section>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2025 MasjidDigital. All rights reserved.</p>
            </div>
        </div>
    </footer>
